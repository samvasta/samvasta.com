...
const skillList: SkillGroup[] = [
  {
    ...
    skills: [
      ...
      },
      {
        name: "Java",
        description:
          `I learned Java as my first OOP language in highschool. I have since used it personally to create video games,
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "CSS",
        description: "I can't claim to have mastered CSS, but I have mastered browsing stackoverflow to solve my CSS problems."
      },
      {
        name: "HTML",
      ...
      {
        name: "Bootstrap",
        description: "I teamed up with another developer to create a fully featured real-time IoT product demo using bootstrap and vanilla JS in under 1 month."
      },
      {
        name: "Chakra-UI",
...
const flatSkills = flatMap(skillList, (group) => group.skills);

export {Skill, SkillGroup, skillList, flatSkills};