  ...
  return (
    <Container variant="article">
      ...
      <Text variant="para">
        ...
        was awesome when it worked, but I don&apos;t think it worth keeping for Mk. II.
      </Text>
      ...
      <Text variant="para">
        ...
        (called the &quot;dead zone&quot;) in was too big. I ended up having to set the dead zone to
      ...
      <Text variant="para">
        Finally, the thumbstick is difficult to move precisely. The stick takes a lot of force to
        get moving so by the time it&apos;s moving you have already pushed it against the edge of
        its restraining outer ring. It is also difficult to move the thumbstick at any angle off of
        the X/Y axes unless the stick is riding against that outer ring.
      </Text>
      <Text variant="para">
        The end result was that the thumbstick acted more like an 8-direction D-pad, nullifying the
        utility of the thumbstick. I&apos;m not giving up on the idea of controlling the mouse, but
        I am giving up on that particular component, and the ADC embedded in the microcontroller.
      </Text>
      ...
      <Text variant="para">
        ...
        original, including the outline and layout.
      </Text>
