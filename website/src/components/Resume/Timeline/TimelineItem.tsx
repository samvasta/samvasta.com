    ...
    <>
      ...
      <GridItem onClick={onToggle} cursor="pointer">
        <Grid
          templateRows={{
            base: '1fr auto 1fr',
            md: `${theme.sizes[itemMargin + 4]} ${theme.sizes[8]} 1fr`,
          }}
          mx={lineMargin}
          justifyItems="center"
          h="full"
        >
          ...
          <Circle
            size={8}
            bg={isActive ? 'transparent' : lineColor}
            borderColor={lineColor}
      ...
      <GridItem onClick={onToggle} cursor="pointer">
        ...
        >
          ...
          {activeContent && (
            <>
              {!alwaysActive && (
                <Text color="red.500" visibility={isActive ? 'hidden' : 'visible'}>
                  Read more{' '}
                </Text>
              )}
