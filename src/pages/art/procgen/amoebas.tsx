...
import { GenAmoebas } from 'data/Art/procgen';
import getGalleryUrls from 'data/gcp';
import { GetStaticProps } from 'next';
import React from 'react';

const ArtAlgAmoebas = (props: GalleryProps) => {
  return (
    <Container variant="article">
      <ArticleHeading>Amoebas</ArticleHeading>
...
export const getStaticProps: GetStaticProps = async () => {
  const galleryUrls = await getGalleryUrls(GenAmoebas);
...
export default BasePage(ArtAlgAmoebas, {
  meta: {
    title: 'Amoebas',
  },
});
